package com.schmudu.wedding.view.screens{
	...
	public class ScreenNewYorkWedding extends AbstractScreen{
		//debug
		...
		public function ScreenNewYorkWedding(){
		}
		...
		override public function initWithIntro(p_intro:Boolean):void{
			...
			_classType = "[object ScreenNewYorkWedding]";
		...
		private function loadMovieClip(){
			...
			if(_highBandwidthMCSelected){				
				_featureNS.play("./movies/NewYorkWedding_High.f4v");
			}
			else{
				_featureNS.play("./movies/NewYorkWedding_Low.f4v");
			}
